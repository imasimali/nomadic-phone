      ...
      <Card>
        <CardContent>
          ...
          <Stack spacing={2}>
            ...
            <Button variant="contained" size="large" startIcon={<Send />} onClick={sendMessage} disabled={loading || !phoneNumber.trim() || !message.trim()} sx={{ minHeight: 56 }}>
        ...
        <CardContent>
          ...
          <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
            {['+1 (555) 123-4567', '+1 (555) 987-6543', '+1 (555) 555-5555'].map((number) => (
              <Button key={number} variant="outlined" size="small" onClick={() => setPhoneNumber(number)} disabled={loading} sx={{ mb: 1 }}>
                {number}
              </Button>
            ))}
          </Stack>
