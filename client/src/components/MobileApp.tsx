    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <AppBar position="static" elevation={0}>
        <Toolbar>
          ...
          {/* User Menu */}
          <IconButton size="large" aria-label="account menu" onClick={handleProfileMenuOpen} color="inherit">
            <Avatar sx={{ width: 32, height: 32, bgcolor: 'secondary.main' }}>{user?.username?.charAt(0).toUpperCase()}</Avatar>
          </IconButton>
