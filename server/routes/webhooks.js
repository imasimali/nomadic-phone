...
router.post('/voice/incoming', validateTwilioRequest, asyncHandler(async (req, res) => {
...
router.post('/voice/outbound', validateTwilioRequest, asyncHandler(async (req, res) => {
  const { To } = req.body;
...
router.post('/voice/status', validateTwilioRequest, asyncHandler(async (req, res) => {
...
router.post('/voice/recording', validateTwilioRequest, asyncHandler(async (req, res) => {
...
// Handle incoming SMS
router.post('/sms/incoming', validateTwilioRequest, asyncHandler(async (req, res) => {
  const {
...
router.post('/sms/status', validateTwilioRequest, asyncHandler(async (req, res) => {
